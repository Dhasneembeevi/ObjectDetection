...
def scale_coords(img1_shape, coords, img0_shape, ratio_pad=None):
    ...
    if ratio_pad is None:  # calculate from shapes
        gain = min(img1_shape[0] / img0_shape[1], img1_shape[1] / img0_shape[0])  # gain = old / new
        pad = ((img1_shape[1] - img0_shape[0] * gain) / 2,  # width padding
               (img1_shape[0] - img0_shape[1] * gain) / 2)  # height padding
    else:
        gain = ratio_pad[0][0]
        pad = ratio_pad[1]
